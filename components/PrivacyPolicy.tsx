      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            {/* 1. Introduction */}
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">1. Introduction</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">2. Intellectual Property & Content Ownership</h2>

              <h3 className="text-xl font-semibold text-versebox-text mb-3">2.1 Your Ownership Rights</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
                <strong>You retain complete ownership of all content you publish on VerseBox.</strong> We make no claim to ownership of your creative works, including but not limited to:
              </p>
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">2.2 License Grant to Inkwing</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">2.3 Your Representations</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">3. Copyright Protection & Dispute Resolution</h2>

              <h3 className="text-xl font-semibold text-versebox-text mb-3">3.1 Copyright Infringement Policy</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">3.2 First Publisher Priority</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">3.3 Copyright Dispute Process</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
                If you believe content infringes your copyright:
              </p>

              <div className="mb-4">
                <p className="font-semibold text-versebox-text mb-2">Step 1: Submit a Report</p>
                <ul className="list-disc list-inside text-versebox-text-secondary space-y-1">
              ...
              <div className="mb-4">
                <p className="font-semibold text-versebox-text mb-2">Step 2: Review Process</p>
                <ul className="list-disc list-inside text-versebox-text-secondary space-y-1">
              ...
              <div className="mb-4">
                <p className="font-semibold text-versebox-text mb-2">Step 3: Resolution</p>
                <ul className="list-disc list-inside text-versebox-text-secondary space-y-1">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">3.4 Counter-Notification</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">3.5 Repeat Infringement</h3>
              <p className="text-versebox-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">4. Platform Role & Liability Limitations</h2>

              <h3 className="text-xl font-semibold text-versebox-text mb-3">4.1 Platform as a Neutral Host</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">4.2 No Legal Relationship</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">4.3 Disclaimer of Warranties</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">4.4 Limitation of Liability</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">5. Prohibited Content & Conduct</h2>

              <h3 className="text-xl font-semibold text-versebox-text mb-3">5.1 Content Restrictions</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">5.2 Prohibited Conduct</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
                Users must not:
              </p>
              <ul className="list-disc list-inside text-versebox-text-secondary space-y-1">
                <li><strong>Plagiarize or republish content found on VerseBox</strong> as their own work elsewhere</li>
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">5.3 Plagiarism & Content Theft</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">6. Account Suspension & Termination</h2>

              <h3 className="text-xl font-semibold text-versebox-text mb-3">6.1 Grounds for Suspension</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">6.2 Suspension Process</h3>
              <ul className="list-disc list-inside text-versebox-text-secondary space-y-1 mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">6.3 Appeals</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">7. Reporting & Content Moderation</h2>

              <h3 className="text-xl font-semibold text-versebox-text mb-3">7.1 Reporting System</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">7.2 Review Process</h3>
              <ul className="list-disc list-inside text-versebox-text-secondary space-y-1">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">7.3 Standing with Original Creators</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">8. Data Collection & Privacy</h2>

              <h3 className="text-xl font-semibold text-versebox-text mb-3">8.1 Information We Collect</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
                We collect:
              </p>
              <ul className="list-disc list-inside text-versebox-text-secondary space-y-1">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">8.2 How We Use Your Information</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">8.3 Data Sharing</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">8.4 Data Security</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">8.5 Your Privacy Rights</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <p className="text-versebox-text-secondary leading-relaxed">
                To exercise these rights, contact us at privacy@versebox.com
              </p>

              <h3 className="text-xl font-semibold text-versebox-text mb-3">8.6 Data Retention</h3>
              <ul className="list-disc list-inside text-versebox-text-secondary space-y-1">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">9. Children's Privacy</h2>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
                VerseBox is open to users of all ages, including children. We take children's privacy seriously:
              </p>
              <ul className="list-disc list-inside text-versebox-text-secondary space-y-1 mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">10. International Users</h2>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <ul className="list-disc list-inside text-versebox-text-secondary space-y-1">
                ...
                <li>You agree to comply with local laws regarding online content</li>
                <li>Different jurisdictions may have different privacy protections</li>
              </ul>
            </section>

            {/* 11. Changes to This Agreement */}
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">11. Changes to This Agreement</h2>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">12. User Responsibilities</h2>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">13. Content Backup & Data Loss</h2>

              <h3 className="text-xl font-semibold text-versebox-text mb-3">13.1 Our Efforts</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">13.2 Your Responsibility</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">14. Third-Party Links & Services</h2>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">15. Governing Law & Dispute Resolution</h2>

              <h3 className="text-xl font-semibold text-versebox-text mb-3">15.1 Governing Law</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
                This Agreement is governed by the laws of [Your Jurisdiction], without regard to conflict of law principles.
              </p>

              <h3 className="text-xl font-semibold text-versebox-text mb-3">15.2 Dispute Resolution</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
                In case of disputes:
              </p>
              <ul className="list-disc list-inside text-versebox-text-secondary space-y-1">
                <li><strong>Informal Resolution:</strong> Contact us first to resolve issues</li>
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">15.3 Exceptions</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
            ...
            {/* 16. Severability */}
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">16. Severability</h2>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
            ...
            {/* 17. Entire Agreement */}
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">17. Entire Agreement</h2>
              <p className="text-versebox-text-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">18. Contact Information</h2>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
                For questions, concerns, or to report violations:
              </p>
              <div className="space-y-2 text-versebox-text-secondary">
                <p><strong className="text-versebox-text">Email:</strong> support@inkwing.com</p>
                <p><strong className="text-versebox-text">Copyright Issues:</strong> copyright@inkwing.com</p>
                <p><strong className="text-versebox-text">Privacy Concerns:</strong> privacy@inkwing.com</p>
                <p><strong className="text-versebox-text">General Inquiries:</strong> info@inkwing.com</p>
                <div className="mt-4">
                  <p><strong className="text-versebox-text">Mailing Address:</strong></p>
                  <p>Inkwing</p>
            ...
            {/* 19. Acknowledgment */}
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">19. Acknowledgment</h2>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
            ...
            {/* 20. Additional Terms */}
            <section>
              <h2 className="text-2xl font-bold text-versebox-text mb-4">20. Additional Terms</h2>

              <h3 className="text-xl font-semibold text-versebox-text mb-3">20.1 Content Preservation</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">20.2 Feature Changes</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">20.3 Account Inactivity</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-versebox-text mb-3">20.4 Content Licensing to Third Parties</h3>
              <p className="text-versebox-text-secondary leading-relaxed mb-4">
