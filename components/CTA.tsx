          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 p-6 sm:p-8 md:p-12 lg:p-16">
            ...
            <div className="text-white">
              ...
              <div className="text-base sm:text-lg text-white/90 mb-6 sm:mb-8 leading-relaxed space-y-4">
                ...
                <p>
                  INKWINGS is that audience. We're that community. This is that
                  moment.
                </p>
                <p>
                  Stop hiding your creativity. Stop letting social media dictate
                  your worth. Stop waiting for permission to share your art.
                </p>
                <p className="font-semibold">
                  Download INKWINGS today and become one of the founding
                  creators who help build the world's premier creative writing
                  platform. Your first piece could be published in the next 10
              ...
              <div className="space-y-4 mb-6">
                ...
                <p className="text-white/80 text-sm">
                  Available now on Google Play and App Store. No credit card
                  required. No hidden fees. Just pure creative freedom.
                </p>
              </div>
