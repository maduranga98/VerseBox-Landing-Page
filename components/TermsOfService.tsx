  ...
  return (
    <section id="terms" className="py-20 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {termsHighlights.map((term, index) => {
            ...
            return (
              <div
                key={index}
                className="p-8 bg-inkwings-surface rounded-2xl hover:shadow-inkwings transition-all duration-300"
              >
        ...
        {/* Detailed Terms */}
        <div className="bg-inkwings-surface rounded-2xl p-8 md:p-12">
          ...
          <div className="space-y-6 text-inkwings-text-secondary">
            ...
            <div>
              <h4 className="font-semibold text-inkwings-text mb-2">2. User Account</h4>
              <p>
            ...
            <div>
              <h4 className="font-semibold text-inkwings-text mb-2">5. Content Moderation</h4>
              <p>
            ...
            <div>
              <h4 className="font-semibold text-inkwings-text mb-2">7. Changes to Terms</h4>
              <p>
